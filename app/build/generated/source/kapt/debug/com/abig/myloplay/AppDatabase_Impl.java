  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `playlists` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `userId` TEXT NOT NULL, `songIds` TEXT NOT NULL, `userName` TEXT, `time` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '370d5c2d8f9a101e999134c8cd64769c')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsPlaylists.put("songIds", new TableInfo.Column("songIds", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "370d5c2d8f9a101e999134c8cd64769c", "7478d5348c69913634cec8bb237a4c9c");
